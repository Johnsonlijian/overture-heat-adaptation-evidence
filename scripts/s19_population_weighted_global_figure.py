"""
POPULATION_WEIGHTED_SYNTHESIS global heat-readiness mismatch figure.
...
def main() -> None:
    ...
    ax_title.axis("off")
    ax_title.text(0.0, 0.78, "Fig. 1 | Heat-exposed urban centres remain vertically evidence-blind", fontsize=14, weight="bold", color=COL["ink"])
    ax_title.text(
        0.0,
        0.24,
    ...
    for ext in ("png", "svg", "pdf"):
        fig.savefig(FINAL / f"Fig1.{ext}", bbox_inches="tight")
    plt.close(fig)
